...
export const DEMO_ACTIVITIES: Activity[] = [
  {
    ...
    category: 'transport',
    details: { vehicle: 'bus', distanceKm: 48, origin: 'Home', destination: 'Office' },
    co2kg: 4.272,
  ...
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'food',
    details: { foodType: 'beefLamb', meals: 2 },
    co2kg: 12,
  ...
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'energy',
    details: { electricityKwh: 18, gasM3: 2.3 },
    co2kg: 9.104,
    timestamp: demoTimestamp(new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000)) as never,
    date: getDaysAgoString(1),
  },
  ...
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'transport',
    details: { vehicle: 'metroTrain', distanceKm: 28, origin: 'Metro Station', destination: 'Campus' },
    co2kg: 1.148,
  ...
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'food',
    details: { foodType: 'vegan', meals: 3 },
    co2kg: 1.5,
    timestamp: demoTimestamp(new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000)) as never,
    date: getDaysAgoString(5),
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'energy',
    details: { electricityKwh: 9.2, gasM3: 0.6 },
    co2kg: 3.084,
  ...
  },
  {
    ...
    userId: DEMO_PROFILE.uid,
    category: 'shopping',
    details: { shoppingCategory: 'other', quantity: 4 },
    co2kg: 20,
